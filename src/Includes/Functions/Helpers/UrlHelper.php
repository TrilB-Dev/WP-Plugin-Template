...
final class UrlHelper {
	 ...
	 */
	public static function admin_page( string $page, array $args = array() ): string {

		$url = admin_url( 'admin.php' );

		return (string) add_query_arg( array_merge( array( 'page' => SanitizationHelper::key( $page ) ), $args ), $url );
	}
	/**
	 ...
	 */
	public static function admin_action( string $action, array $args = array() ): string {

		return (string) add_query_arg( array_merge( array( 'action' => SanitizationHelper::key( $action ) ), $args ), admin_url( 'admin-post.php' ) );
	}
	/**
	 ...
	 */
	public static function admin_action_nonce( string $action, string $nonce_action, array $args = array() ): string {
