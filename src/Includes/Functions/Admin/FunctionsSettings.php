...
final class FunctionsSettings {
	...
	public function register_settings(): void {
		register_setting( 'pluginname_settings', 'pluginname_general', array( 'sanitize_callback' => array( $this, 'sanitize_general' ) ) );
		register_setting( 'pluginname_settings', 'pluginname_layout', array( 'sanitize_callback' => array( $this, 'sanitize_layout' ) ) );
		register_setting( 'pluginname_settings', 'pluginname_access', array( 'sanitize_callback' => array( $this, 'sanitize_access' ) ) );
		register_setting( 'pluginname_settings', 'pluginname_tools', array( 'sanitize_callback' => array( $this, 'sanitize_tools' ) ) );
