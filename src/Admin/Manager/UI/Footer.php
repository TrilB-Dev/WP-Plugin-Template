	...
	public static function render(): void {
		...
		<footer class="pluginname-footer border-top">
			<div class="container-fluid px-3 px-lg-4 py-3 d-flex flex-wrap justify-content-between align-items-center gap-2">
				...
				<span class="small text-secondary"><?php esc_html_e( 'Powered by', 'pluginname' ); ?> <a class="fw-semibold text-decoration-none" href="https://github.com/TrilB-Dev/PluginName" target="_blank" rel="noopener noreferrer">PluginName</a></span>
			</div>
		</footer>
		<?php
	}
